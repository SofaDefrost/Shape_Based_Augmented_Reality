...
def crop_points_cloud(image_path,points_cloud,couleurs):
    ...
    bottom_left_corner = (y_min-1)*640 +x_min
    top_left_corner = (y_max-1)*640 +x_min
    bottom_right_corner = (y_min-1)*640 +x_max
    top_right_corner = (y_max-1)*640 +x_max
    ...
    while(bottom_left_corner != top_left_corner):
        ...
        bottom_left_corner = (y_min+i-1)*640 +x_min
        bottom_right_corner = (y_min+i-1)*640 +x_max
        i+=1
    cv2.waitKey(0)
