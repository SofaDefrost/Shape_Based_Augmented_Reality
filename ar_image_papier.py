...
name_pc_file = "data/labo_biologie/4eme_semaine/chick_cont_22.ply"
...
while pc_too_big:
    try:
        points_model_3D_resized,scaling_factor = pc.resize_point_cloud_to_another_one(
...
points_model_3D_resized,colors_model_3D=ply.get_points_and_colors("data/labo_biologie/4eme_semaine/chick_3D_cont_2_back.ply")
points_model_3D_resized,_=pc.resize_with_scaling_factor(points_model_3D_resized,scaling_factor)
colors_projection_cpi = proj.project_3D_model_on_pc_using_closest_points_identification(points_model_3D_resized,colors_model_3D, points, colors, M,size_acqui)
